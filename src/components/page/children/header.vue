<template>
    <div class="teacher-main">
        <header class="header">
            ...
            <div class="input-main fl" v-if="sea"><input type="text" v-model="$store.state.search_value"  @keyup.enter="searchData" placeholder="请输入商品名称..."></div>
            ...
            <div class="service" v-if="btn" @click ="toOrder">{{btn}}</div>
...
<script>
    ...
    export default {
        ...
        methods:{
            searchData(){
                this.axios.get(API_URL + 'Home/Index/keyWordSearch',{
                    params:{
